...
int main(){
	...
	result = cardEffect(smithy, choice1, choice2, choice3, &testState, handPos, &bonus)

	
	//TEST 1 - handcount should be 7 (5 initial +3 new - 1 discard )
	printf("\nConfirm HandCount has increased by 3 cards:\n")
	expHandCount = expState.handCount[A] + 3 - 1; 
