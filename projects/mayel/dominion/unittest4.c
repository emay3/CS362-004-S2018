...
----------------------------------------*/
	printf("\nUnitTest 4.2 - GainCard from Full Supply to Hand\n");
...
---------------------------------------*/
	printf("\nUnitTest 4.3 - GainCard to Deck:\n");
	
	memcpy(&deckState, &testState, sizeof(struct gameState));
	result = gainCard(estate, &testState, 1, 1);
	//if(result != 0){
...
--------------------------------------*/
	...
	printf("\nUnitTest 4.4 - GainCard to Discard\n");
	memcpy(&discardState, &testState, sizeof(struct gameState));
